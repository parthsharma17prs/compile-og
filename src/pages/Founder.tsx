            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="w-full md:w-2/3">
                ...
                <div className="prose prose-lg max-w-none text-foreground/90">
                  ...
                  <p className="mb-6">
                    Auditors still asked for screenshots, spreadsheets, and static reports, while teams were deploying cloud-native systems, smart contracts, and AI-driven applications at lightning speed. The gap between how companies innovate and how regulators verify trust was only getting wider.
                  </p>
